    ...
    <section className="py-44 bg-[#050505] bg-noise relative overflow-hidden border-t border-white/[0.03]">
      ...
      <div className="max-w-7xl mx-auto px-10 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-44">
          ...
          <p className="text-sm sm:text-base text-white/50 leading-relaxed font-normal max-w-xl mx-auto tracking-wide font-sans">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-stretch">
            ...
            <div>
              <div className="flex items-center justify-between border-b border-white/5 pb-5 mb-8">
                <div className="flex items-center gap-2.5">
                  ...
                  <h3 className="text-xs font-tech font-bold text-white tracking-widest uppercase">Active Task Stack</h3>
                </div>
                <span className="text-[10px] font-tech bg-white/5 border border-white/10 text-white/50 px-3 py-1 rounded-full font-bold uppercase tracking-widest">
                  AI Sorted
                </span>
              </div>
              ...
              <form onSubmit={addTask} className="flex gap-3 mb-8">
                ...
                <button 
                  type="submit"
                  className="bg-transparent hover:bg-white text-white hover:text-black border border-white/30 hover:shadow-lg hover:shadow-white/10 text-xs font-tech font-bold uppercase tracking-widest px-6 py-3.5 rounded-xl transition-all duration-500 shrink-0 flex items-center gap-1.5 cursor-pointer active:scale-[0.98]"
                >
                ...
                {tasks.map((task) => (
                  ...
                  >
                    <div className="flex items-center gap-4 min-w-0">
                      ...
                      <span className={`text-sm font-medium truncate font-sans ${task.completed ? 'line-through text-white/30' : 'text-white/80'}`}>
                        {task.title}
                      </span>
                    </div>
                    ...
                    <div className="flex items-center gap-4 shrink-0">
                      ...
                      <span className="text-xs font-tech text-white/40 flex items-center gap-1">
          ...
          <div className="lg:col-span-4 flex flex-col gap-8">
            ...
            {/* AI Nudge Card */}
            <div className="bg-[#090909] border border-white/5 rounded-3xl p-8 relative overflow-hidden flex-1 flex flex-col justify-between hover:border-white/10 transition-all duration-500 layered-shadow-lg hover:layered-shadow-xl">
              <div>
                ...
                <div className="min-h-[140px] flex flex-col justify-center">
                  {incompleteTasks.length === 0 ? (
                    <p className="text-[13px] text-status-green font-normal leading-relaxed tracking-wide font-sans">
                    ...
                    <p className="text-[13px] text-white/70 font-normal leading-relaxed tracking-wide font-sans">
              ...
              <div className="border-t border-white/5 pt-5 mt-8">
                <button 
                  ...
                  className="w-full py-3.5 rounded-xl text-xs font-tech font-bold tracking-widest uppercase border border-white/20 hover:bg-white hover:text-black hover:border-white text-white transition-all flex items-center justify-center gap-2 cursor-pointer"
                >
            ...
            <div className="bg-[#090909] border border-white/[0.05] rounded-3xl p-8 layered-shadow-lg">
              <h4 className="text-xs font-tech font-bold tracking-widest uppercase text-white/35 mb-5">System Telemetry</h4>
              <div className="grid grid-cols-2 gap-4">
                <div className="p-4 bg-[#050505] border border-white/5 rounded-2xl">
                  <span className="text-[10px] font-tech text-white/35 block mb-1">Risk Level</span>
                ...
                <div className="p-4 bg-[#050505] border border-white/5 rounded-2xl">
                  <span className="text-[10px] font-tech text-white/35 block mb-1">Focus Burden</span>
                ...
                <div className="p-4 bg-[#050505] border border-white/5 rounded-2xl col-span-2 flex items-center justify-between">
                  <span className="text-[10px] font-tech text-white/35">Completion Rate</span>

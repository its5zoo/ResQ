              ...
              <div className="p-5 pt-11 flex-1 flex flex-col justify-between text-left">
                ...
                <div>
                  <div className="flex items-center justify-between mb-8">
                    <div>
                      <span className="text-sm text-white/60 block">Good morning</span>
                      <h4 className="text-sm font-bold text-white uppercase tracking-wider">Faizaan Khan</h4>
                    </div>
                  ...
                  <div className="p-4 bg-white/5 border border-white/10 rounded-2xl mb-6 space-y-1.5">
                    <span className="text-sm font-tech font-bold text-white/70 uppercase tracking-wider block font-display">AI Action Nudge</span>
                    <p className="text-sm text-white/60 leading-relaxed font-light">"2 deadlines approaching today. I have blocked a focus session for you at 4 PM."</p>
                  </div>
 
                  {/* Task Checklist Panel */}
                  <div className="space-y-3">
                    <span className="text-sm font-tech bg-white/5 border border-white/10 text-white/60 px-3 py-1 rounded-full font-bold uppercase tracking-widest inline-block mb-3">Today's Tasks</span>
                    <div className="p-3 bg-[#090909] rounded-xl border border-white/[0.04] flex items-center justify-between">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-sm text-white/70">Submit Project Report</span>
                      </div>
                      <span className="text-sm bg-status-red/10 text-status-red px-2 py-0.5 rounded-full font-bold">2h</span>
                    </div>
                    <div className="p-3 bg-[#090909] rounded-xl border border-white/[0.04] flex items-center justify-between">
                      <div className="flex items-center gap-2">
                        <span className="w-1.5 h-1.5 rounded-full bg-status-blue"></span>
                        <span className="text-sm text-white/70">Design UI Assets</span>
                      </div>
                      <span className="text-sm bg-status-blue/10 text-status-blue px-2 py-0.5 rounded-full font-bold">4 PM</span>
                    </div>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="p-4 bg-[#090909] rounded-2xl border border-white/[0.04] flex items-center justify-between mb-5">
                    <div className="flex items-center gap-2.5">
                      ...
                      <div>
                        <span className="text-sm text-white/80 font-bold uppercase tracking-wider">Gym Workout</span>
                        <span className="text-sm text-white/60 block">🔥 7 Days Streak</span>
                      </div>
                    </div>
                    <span className="text-sm bg-white/5 border border-white/10 text-white px-2 py-0.5 rounded-full font-bold">DONE</span>
                  </div>
 
                  {/* Bottom Navigation mock */}
                  <div className="border-t border-white/5 pt-4 flex items-center justify-around text-white/50 text-sm font-bold uppercase tracking-wider">
          ...
          <div className="flex flex-wrap gap-4 mb-6">
            ...
            >
              ...
              <div className="text-left font-sans">
                <span className="block text-sm uppercase tracking-widest text-white/70 group-hover:text-white/60 transition-colors leading-none mb-0.5">Download on the</span>
                <span className="block text-sm font-semibold text-white leading-tight">App Store</span>
              </div>
            </a>
            ...
            >
              ...
              <div className="text-left font-sans">
                <span className="block text-sm uppercase tracking-widest text-white/70 group-hover:text-white/60 transition-colors leading-none mb-0.5">Get it on</span>
                <span className="block text-sm font-semibold text-white leading-tight">Google Play</span>
              </div>
            </a>
          </div>

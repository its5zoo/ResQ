        ...
        <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          ...
          <div className="order-2 lg:order-1 relative goal-img">
            ...
            <div className="absolute -top-6 -right-6 bg-[#0B0B0B] border border-white/10 rounded-2xl p-4 shadow-2xl flex items-center gap-4 animate-bounce-slow" style={{ animationDelay: '1s' }}>
              ...
              <div>
                ...
                <p className="text-sm font-semibold text-white/80">Milestones refined</p>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-8 order-1 lg:order-2">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/5 border border-white/10 goal-text">
              ...
              <span className="text-sm font-bold uppercase tracking-widest text-white/70">Strategic Planning</span>
            </div>
            ...
            <div className="space-y-6 pt-4 goal-text">
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-white/70 leading-relaxed mt-1">Set a deadline and draft rough milestones. The system handles the timeline.</p>
                </div>
              </div>
              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-white/70 leading-relaxed mt-1">Gemini AI analyzes your inputs and rewrites them into crystal-clear, actionable directives.</p>
                </div>
              </div>
            </div>
          </div>

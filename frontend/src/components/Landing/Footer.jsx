...
export default function Footer() {
  return (
    <footer className="py-24 border-t border-white/[0.04] bg-[#050505] bg-noise relative z-20 font-sans">
      <div className="max-w-7xl mx-auto px-10 sm:px-12 md:px-16">
        
        {/* Top Grid */}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-x-12 gap-y-16 pb-20 border-b border-white/5">
          ...
          <div className="lg:col-span-3 space-y-8 pr-4">
            ...
            <div className="text-xs text-white/40 font-light space-y-1.5 pt-2">
              <p className="tracking-wider uppercase text-white/30 font-semibold text-[10px] font-tech">Built for Vibe2Ship Hackathon</p>
          ...
          <div className="lg:col-span-2 space-y-6">
            <h4 className="text-[11px] font-tech font-bold uppercase tracking-[0.2em] text-white/50 flex items-center gap-2">
          ...
          <div className="lg:col-span-4 space-y-6 pl-0 lg:pl-8 border-t lg:border-t-0 lg:border-l border-white/5 pt-12 lg:pt-0">
            ...
            <div className="space-y-4 text-sm text-white/50 font-light">
              <div className="flex items-start gap-3">
                <User className="w-4.5 h-4.5 text-white/40 shrink-0 mt-0.5" />
                <div>
                  <span className="font-semibold text-white/85 text-[15px]">MD Faizaan Raza Khan</span>
                  <span className="block text-[10px] font-tech uppercase tracking-wider text-white/40 mt-1">Lead Developer</span>
                </div>
              </div>
              ...
              <div className="flex items-center gap-3 pt-4 border-t border-white/5">
                ...
                <span className="text-xs text-white/40 tracking-wider">faizaan@giet.edu (Developer Contact)</span>
              </div>
            </div>
          </div>
        ...
        <div className="pt-10 flex flex-col sm:flex-row items-center justify-between gap-6 text-xs text-white/30 font-light tracking-wider uppercase font-tech">
